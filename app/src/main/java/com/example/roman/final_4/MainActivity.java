    ...
    public void onClick (View v){
        switch (v.getId()){
            ...
            case (R.id.Btn_call):
                ...
                break;
            case  (R.id.Btn_menu):
                Intent browseIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://media.wix.com/ugd/502aca_d01f47ab19454a34a4f4f1a4face7fad.pdf"));
                startActivity(browseIntent);
                break;
            case (R.id.img_Btn_maps):
                geoUri = Uri.parse(geoUriString);
                geoIntent = new Intent(Intent.ACTION_VIEW, geoUri);
                startActivity(geoIntent);
                break;
            case (R.id.img_Btn_call):
                phoneIntent = new Intent(Intent.ACTION_DIAL, Uri.parse(phoneNub));
                startActivity(phoneIntent);
                break;
